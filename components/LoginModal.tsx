        ...
        >
            ...
            >
                <header className="flex items-center justify-between p-4 border-b border-gray-700">
                    <h2 id="login-title" className="text-lg font-bold text-brand-light">Log In to LegalIQ.app</h2>
                ...
                <main className="p-6 sm:p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            <div className="text-sm">
                                <a href="#" className="font-medium text-brand-gold hover:text-yellow-300">Forgot your password?</a>
                            </div>
                        </div>
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm"><span className="bg-brand-card px-2 text-gray-400">Or continue with</span></div>
                        </div>
                        <div className="mt-6">
                            <button onClick={handleGoogleSignIn} className="flex w-full items-center justify-center gap-3 rounded-md bg-brand-dark px-3 py-2.5 text-sm font-semibold text-white shadow-sm ring-1 ring-inset ring-gray-700 hover:bg-gray-800 focus-visible:outline-offset-0">
                 ...
                 <footer className="p-4 bg-brand-dark/30 text-center text-sm border-t border-gray-700">
                    <p className="text-gray-400">
                        ...
                        <button onClick={onSwitchToSignUp} className="font-medium text-brand-gold hover:text-yellow-300">Sign up</button>
                    </p>
                </footer>
            </div>
        </div>
