...
const menuItems: MenuItem[] = [
    { id: 'features', labelKey: 'nav_features' },
    { id: 'how-to-use', labelKey: 'nav_how_to_use' },
    { id: 'ai-legal-team', labelKey: 'nav_ai_legal_team' },
    { id: 'use-cases', labelKey: 'nav_use_cases' },
    { id: 'trust-and-security', labelKey: 'nav_trust_security' },
    { id: 'testimonials', labelKey: 'nav_testimonials' },
    { id: 'mission-vision', labelKey: 'nav_mission_vision' },
];
