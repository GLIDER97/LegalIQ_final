...
export const VaniMitra: React.FC<VaniMitraProps> = ({ isOpen, onClose, documentText, analysisResult, chatHistory, setChatHistory, currentAnalysisId }) => {
...
${analysisContext}`;
                ...
                onmessage: async (message: LiveServerMessage) => {
                    ...
                    if (message.serverContent?.turnComplete) {
                        ...
                        if (currentUser && currentAnalysisId) {
                            updateChatHistory(currentUser.uid, currentAnalysisId, newMessages);
                        }
    ...
    }, [documentText, analysisResult, language, t, disconnect, setChatHistory, currentAnalysisId, currentUser]);
